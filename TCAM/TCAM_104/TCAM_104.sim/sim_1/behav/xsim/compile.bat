...
REM
REM Generated by Vivado on Sun Mar 08 19:16:14 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj TB_TCAM_vlog.prj"
call xvlog  --incr --relax -L uvm -prj TB_TCAM_vlog.prj -log xvlog.log
